...
const STANDARD_LAYERS = [
  { order_index: 0,  layer_key: 'background',   label_es: 'Fondo',          label_en: 'Background',   type: 'image', blend_mode: 'source-over', color_token: null,         optional: false, locked: false, visible_in_builder: true,  opacity: 1 },
  { order_index: 1,  layer_key: 'emotion',       label_es: 'Emoción',        label_en: 'Emotion',      type: 'svg',   blend_mode: 'source-over', color_token: null,         optional: true,  locked: false, visible_in_builder: true,  opacity: 1 },
  { order_index: 2,  layer_key: 'hair-back',     label_es: 'Cabello atrás',  label_en: 'Back hair',    type: 'svg',   blend_mode: 'source-over', color_token: 'hair-color', optional: false, locked: false, visible_in_builder: true,  opacity: 1 },
  { order_index: 3,  layer_key: 'head',          label_es: 'Cabeza',         label_en: 'Head',         type: 'svg',   blend_mode: 'source-over', color_token: 'skin-color', optional: false, locked: false, visible_in_builder: true,  opacity: 1 },
  { order_index: 4,  layer_key: 'body',          label_es: 'Cuerpo',         label_en: 'Body',         type: 'svg',   blend_mode: 'source-over', color_token: 'skin-color', optional: false, locked: false, visible_in_builder: false, opacity: 1 },
  { order_index: 5,  layer_key: 'shirt',         label_es: 'Camiseta',       label_en: 'Shirt',        type: 'svg',   blend_mode: 'source-over', color_token: null,         optional: false, locked: false, visible_in_builder: true,  opacity: 1 },
